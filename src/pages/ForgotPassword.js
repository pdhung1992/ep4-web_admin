                    ...
                    <div className="card">
                        <div className="card-body">
                            ...
                            <p className="mb-4">Enter your email and we'll send you instructions to reset your
                                password</p>
                            <form onSubmit={handleForgotPassword} id="formAuthentication" className="mb-3"
                                  method="POST">
                                <div className="mb-3">
                                ...
                                <button type={"submit"} className="btn btn-primary d-grid w-100">Send Reset Link
                                </button>
                            </form>
            ...
            <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className={`modal-title text-${responseType}`} id="modalToggleLabel">{responseType === 'success' ? 'Success!' : "Error!"}</h5>
                        <button
                            type="button"
                            className="btn-close"
