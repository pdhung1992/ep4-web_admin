...
const Login = () => {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            const data = await authServices.adminLogin(formData);
            if (data && data.token) {
                            ...
                            <div className="card-body">
                                ...
                                <div className="app-brand justify-content-center">
                                    <a href="index.html" className="app-brand-link gap-2">
                                      ...
                                      <span className="app-brand-text text-capitalize demo text-body fw-bolder">Admin Login</span>
                                    </a>
                                </div>
                                {/* /Logo */}
                                <h4 className="mb-2">Welcome to MovieX! 👋</h4>
                                <p className="mb-4">Please sign-in to use Admin page</p>
